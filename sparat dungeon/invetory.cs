...
namespace sparat_dungeon
{
    ...
    public class Item
    {
        ...
        public static List<Item> items = new List<Item>
        {
            ...
            new Item("무쇠 갑옷", "무쇠로 만들어져 튼튼한 갑옷입니다.", 0, 15, 0, 2000, ItemType.Equipment, SlotType.Armor),
            new Item("비단 갑옷", "비단으로 만들어져 고급스러운 갑옷입니다.", 0, 10, 0, 3500, ItemType.Equipment, SlotType.Armor),
            new Item("목검", "나무를 날카롭게 깎아만든 검.", 5, 0, 0, 600, ItemType.Equipment, SlotType.Weapon),
            new Item("낡은 검", "녹슬었지만 아직 날을 잃지 않은 오래된 검.", 10, 0, 0, 1500, ItemType.Equipment, SlotType.Weapon),
            new Item("무쇠 단검", "자객들이 사용하는 무쇠로 만든 날카로운 단검.", 8, 0, 0, 1500, ItemType.Equipment, SlotType.Weapon),
